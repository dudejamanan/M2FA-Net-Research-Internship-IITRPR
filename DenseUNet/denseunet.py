...
class LateFusionDenseUNet(nn.Module):
    def __init__(self, ms_channels=6):
        ...
        self.rgb_net = smp.Unet("densenet121", encoder_weights=None, in_channels=3, classes=2)
        self.ms_net  = smp.Unet("densenet121", encoder_weights=None, in_channels=ms_channels, classes=2)
...
if __name__ == "__main__":
    ...
    for metric in results[0].keys():
        ...
        print(f"{metric}: Mean={mean:.4f}, Std={std:.4f}, Var={var:.6f}")
...
print("\n🎨 Generating DenseUNet Sample Predictions...\n")

# load trained model
model.load_state_dict(torch.load("best_run0.pth"))
